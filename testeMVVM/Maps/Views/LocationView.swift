...
struct LocationView: View {
    ...
    var onLocationPicked: ((LocationCoordinateModel) -> Void)?
    // Optional binding for two-way updates
    @Binding var selectedCoordinate: LocationCoordinateModel?
    private var vm: LocationViewModel { externalVM ?? internalVM }

    init(externalVM: LocationViewModel? = nil,
         onLocationPicked: ((LocationCoordinateModel) -> Void)? = nil,
         selectedCoordinate: Binding<LocationCoordinateModel?> = .constant(nil)) {
