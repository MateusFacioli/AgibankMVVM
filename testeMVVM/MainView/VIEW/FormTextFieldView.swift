        ...
        NavigationStack{
            Form {
                ...
                Section("Informações do Item:") {
                    ...
                    VStack{
                        Picker("Departamento", selection: $alteracaoobj.selectedDepartamento){
                            ForEach(alteracaoobj.departamentos, id: \.self) { departamentos in
                                Text(departamentos).tag(departamentos)
                            }
                        }
                    }
            ...
            .navigationTitle(Text("Consultar Item"))
        }
    }
}
